...
//    output wire    LED,
    ...
    assign addr = hrdata_mem;
//    assign fdone = clk_div;
//    AHBGPIO uAHBGPIO(
//       .HCLK(fclk),
//       .HRESETn(hresetn),
//       .HADDR(haddrs),
...
//        .LCD_RW     (LCD_RW),
//        .LCD_E      (LCD_E),
//        .LCD_D      (LCD_D) // N?i vào dây 8-bit n?i b?
//      );
